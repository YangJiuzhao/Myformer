...
parser.add_argument('--model', type=str, default='former', help='model')
...
parser.add_argument('--in_len', type=int, default=288, help='input MTS length (T)')
parser.add_argument('--out_len', type=int, default=24, help='output MTS length (\tau)')
parser.add_argument('--seg_lens', type=str, default="3,6,12,24", help='segment length (L_seg)')
